            ...
            >
                <div className="hidden sm:block">
                    <p className="text-sm text-gray-700">
                        Showing <span className="font-medium">{isPage * 10 + 1}</span> to <span className="font-medium">{ (isPage + 1) * 10}</span>{' '}
                        of <span className="font-medium">{10 * totalPage}</span> results
                    </p>
                </div>
