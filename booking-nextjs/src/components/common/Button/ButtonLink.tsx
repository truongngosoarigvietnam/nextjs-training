...
export function Button({
    ...
    return href ? (
        <Link
            href={href}
            className={`${className} ${variant} group inline-flex items-center justify-center rounded-full py-2 px-4 text-sm font-bold focus:outline-none focus-visible:outline-2 focus-visible:outline-offset-2 bg-button text-white hover:opacity-80 hover:bg-button active:bg-blue-800 active:text-blue-100 focus-visible:outline-blue-600`}
            {...props}
        />
    ) : (
