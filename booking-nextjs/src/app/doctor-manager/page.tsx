...
import SelectSpecial from '@/components/common/Selection/SelectSpecial';
import SelectClinics from '@/components/common/Selection/SelectClinics';
import CheckboxOptions from '@/components/common/Checkbox/checkboxOptions';
import Markdowns from '@/components/common/Markdown/Markdown';
...
export default function Page() {
    ...
    return (
        <MetaData title={'My information - BookingCare'} className={''}>
            <form onSubmit={handleSubmit(onSubmit)}>
                <div className="space-y-12">
                    <div className="border-b border-gray-900/10 pb-12">
                        <h2 className="text-base font-semibold leading-7 text-gray-900">Details for you</h2>
