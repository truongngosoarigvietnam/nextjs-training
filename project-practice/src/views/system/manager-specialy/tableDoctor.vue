...
export default {
    setup() {
        ...
        function nextPage() {
            ...
            fetchDoctorBySpecial({pageIndex : pageIndex.value , specialId : specialId.value})
        ...
        emitter.on('eventDoctorBySpecial', (id) => {
            // *Listen* for event
            specialId.value = id
                fetchDoctorBySpecial({pageIndex : pageIndex.value , specialId : id})
        });
        return {
            listData,
            totalPage,
